...
const index = () => {
    ...
    return (
        <div>
            <div className=" hidden lg:block service_paren my-16  w-full h-screen  relative ">
                                ...
                                <div key={index} className={`  h-[100vh]   w-full px-5 lg:px-10  overflow-hidden`}>
                                    <div className=" w-full mt-5 md:mt-0 md:w-[45%] p-5 lg:p-14 h-full flex flex-col justify-center">
                                        ...
                                        <div className="w-full flex flex-col gap-[5vw] justify-center  ">
                                            <div className="">
                                                <p className='text-3xl lg:text-6xl  font-semibold service_animate_txt_b'>{item.title}</p>
                                            ...
                                            <div className="stores">
                                                <div className="flex md:flex-col lg:flex-row  lg:items-center gap-1">
                                                    <div className="flex items-center gap-2">
                                                        <RiMapPinFill size={18} className='service_icon translate-y-[-2px]' />
                                                        <p className=' service_animate_txt_d text-xs lg:text-sm font-semibold uppercase  '>Locate Stores:</p>
                                                    </div>

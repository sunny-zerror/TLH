...
const ServicesSection = () => {
    ...
    return (
        <div className='services_parent my-16 lg:my-0  lg:h-screen w-full center  '>
            <div className="   lg:h-[40vw]  w-full overflow-hidden relative">
                {
                        ...
                        <div key={index} className={` slide_bg_${index} top-0 mt-10 lg:mt-0 z-[${index}] blur-[0px]  w-full h-full px-5 lg:px-10 bg-[#FFFAF0] lg:absolute  left-0 overflow-hidden`}>
                            <div className={` slide_inn_${index}  slide_bg  w-full h-full p-5 lg:p-14 flex flex-col-reverse md:flex-row items-center justify-between bg-[#9494941f] rounded-xl`}>
                                <div className=" w-full mt-5 md:mt-0 md:w-[45%] h-full flex flex-col justify-between">
                                    <p className='service_animate_txt_a font-medium md:mb-5 opacity-80'>Our Services</p>
                                    ...
                                    <div className="w-full flex flex-col gap-4 justify-between h-full ">
                                        <div className="">
                                            ...
                                            <div className=" border_anim  w-0 origin-left md:mt-2 border  border-dashed rounded-full border-black/30"></div>
                                        </div>
                                        ...
                                        <div className="stores">
                                            ...
                                            <div className="w-full flex flex-wrap mt-4 gap-2 ">
                                                {item?.cities.map((store, i) => (
                                                    <button key={i} className=' text-xs lg:text-base service_btn relative overflow-hidden group rounded-full border-2 border-[#0e1111] px-4 center font-bold py-1 lg:py-1.5'>
